          ...
          <div class="col text-center py-3">
            ...
            <div class="row">
                <div class="col-md-4 offset-md-3">
                  <div class="row gx-0">
                    <div class="col pt-2">
                    <label for="index-select"><i class="fa-solid fa-filter"></i> Filter Recipes by Category</label>
                    </div>&nbsp;
                    <div class="col">
                      <select name="" id="index-select" class="form-select">
            ...
            ?>
                <div class="col-md-4 my-4">
                  ...
                  <div class="descriptions pix">
                      ...
                      <p><b>Description</b>: <?php echo substr($recipe['recipe_description'],0,100);?></p>
                  </div>
                  </a>
                </div>
